        ...
        {step === 1 && (
          <div className="bg-white border border-outline-variant rounded-xl p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <Button onClick={addFuncReq} variant="outline" size="sm">
            ...
            <div className="space-y-3">
              ...
              {funcReqs.map(req => (
                <div key={req.id} className="flex items-start gap-3 p-3 border border-outline-variant rounded-lg bg-surface-studio group hover:border-ai-vibrant/30 transition-colors">
                  <span className="font-mono font-label-sm text-secondary mt-2 w-6 shrink-0">F-{funcReqs.indexOf(req) + 1}</span>
                  <div className="flex-1 space-y-2">
                    ...
                    <select
                      ...
                      onChange={e => updateFuncReq(req.id, 'sourceActor', e.target.value)}
                    >
        ...
        {step === 2 && (
          <div className="bg-white border border-outline-variant rounded-xl p-8">
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-2">
                {NFR_PRESETS.map(p => (
                  <button
                    key={p.key}
                    onClick={() => toggleNFrPreset(p.text)}
                    className={`px-3 py-1.5 rounded-full font-body-sm border transition-all ${
                      nonFuncReqs.some(r => r.text === p.text)
                        ? 'bg-ai-vibrant/10 border-ai-vibrant text-ai-vibrant'
                        : 'border-outline-variant text-secondary hover:border-ai-vibrant/30'
                    }`}
                  >
                    {nonFuncReqs.some(r => r.text === p.text) ? <Icon name="check" className="text-sm mr-1 inline" /> : <Icon name="add" className="text-sm mr-1 inline" />}
                    {p.text}
                  </button>
                ))}
              </div>
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <Button onClick={addNonFuncReq} variant="outline" size="sm"><Icon name="add" /> Ajouter</Button>
            </div>
            <div className="space-y-3">
              ...
              {nonFuncReqs.map(req => (
                <div key={req.id} className="flex items-center gap-3 p-3 border border-outline-variant rounded-lg bg-surface-studio group hover:border-ai-vibrant/30 transition-colors">
                  <span className="font-mono font-label-sm text-secondary w-6 shrink-0">NF-{nonFuncReqs.indexOf(req) + 1}</span>
                  <input
                    ...
                    value={req.text}
                    onChange={e => updateNonFuncReq(req.id, e.target.value)}
                  />
                  <button
                    onClick={() => removeNonFuncReq(req.id)}
                    className="p-2 text-secondary hover:text-red-500 opacity-0 group-hover:opacity-100 transition-all shrink-0"
                  >
                    <Icon name="delete" />
                  </button>
                ...
                <div className="flex flex-wrap gap-2">
                  {actors.map(a => (
                    <span key={a} className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-ai-vibrant/5 text-ai-vibrant font-body-sm border border-ai-vibrant/20">
                      {a}
                      <button onClick={() => toggleActor(a)} className="ml-1 hover:text-red-500"><Icon name="close" className="text-xs" /></button>
                    </span>
                  ))}
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="p-4 bg-surface rounded-lg border border-outline-variant">
                <h3 className="font-label-md font-mono text-secondary mb-2 flex items-center gap-2">
                  ...
                  <button onClick={() => setStep(0)} className="text-xs text-ai-vibrant hover:underline ml-auto">Modifier</button>
                </h3>
              ...
              <div className="p-4 bg-surface rounded-lg border border-outline-variant">
                <h3 className="font-label-md font-mono text-secondary mb-2 flex items-center gap-2">
                  ...
                  <button onClick={() => setStep(1)} className="text-xs text-ai-vibrant hover:underline ml-auto">Modifier</button>
                </h3>
              ...
              <div className="p-4 bg-surface rounded-lg border border-outline-variant">
                <h3 className="font-label-md font-mono text-secondary mb-2 flex items-center gap-2">
                  ...
                  <button onClick={() => setStep(2)} className="text-xs text-ai-vibrant hover:underline ml-auto">Modifier</button>
                </h3>
              ...
              <div className="p-4 bg-surface rounded-lg border border-outline-variant">
                <h3 className="font-label-md font-mono text-secondary mb-2 flex items-center gap-2">
                  ...
                  <button onClick={() => setStep(3)} className="text-xs text-ai-vibrant hover:underline ml-auto">Modifier</button>
                </h3>
                {actors.length === 0 ? (
